...
@section('content')
    <div class="row">
        <div class="col-xl-6 col-xxl-3 col-lg-6 col-sm-6">
            <div class="row">
                <div class="col-xl-6 col-xxl-3 col-lg-6 col-sm-6">
                        ...
                        <div class="card-body box-style">
                            <div class="media align-items-center">
                                <div class="media-body me-3">
                                    <h2 class="num-text text-black font-w700">150</h2>
                                    <span class="fs-14">Total Kampus</span>
                                </div>
                ...
                <div class="col-xl-6 col-xxl-3 col-lg-6 col-sm-6">
                    <div class="card card-bd">
                        ...
                        <div class="card-body box-style">
                            <div class="media align-items-center">
                                <div class="media-body me-3">
                                    <h2 class="num-text text-black font-w700">2.100</h2>
                                    <span class="fs-14">Pengguna Terdaftar</span>
                                </div>
                                <svg width="36" height="36" viewBox="0 0 36 36" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                ...
                <div class="col-xl-6 col-xxl-3 col-lg-6 col-sm-6">
                    <div class="card card-bd">
                        ...
                        <div class="card-body box-style">
                            <div class="media align-items-center">
                                <div class="media-body me-3">
                                    <h2 class="num-text text-black font-w700">5.430</h2>
                                    <span class="fs-14">Total Program Studi</span>
                                </div>
                ...
                <div class="col-xl-6 col-xxl-3 col-lg-6 col-sm-6">
                    <div class="card card-bd">
                        ...
                        <div class="card-body box-style">
                            <div class="media align-items-center">
                                <div class="media-body me-3">
                                    <h2 class="num-text text-black font-w700">15</h2>
                                    <span class="fs-14">Ulasan Menunggu</span>
                                </div>
        ...
        <div class="col-xl-6">
            <div class="card message-bx">
                <div class="card-header border-0 d-sm-flex d-block pb-0">
                    <div>
                        <h4 class="fs-20 mb-0  text-black mb-sm-0 mb-2">Aktivitas Terbaru</h4>
                    </div>
                </div>
                <div class="card-body">
                    <div class="media mb-3 pb-3 border-bottom">
                        <div class="image-bx me-sm-4 me-2">
                            <img src="{{ asset('assets') }}/public/assets/images/profile/Untitled-1.jpg" alt=""
                        ...
                        <div class="media-body d-sm-flex justify-content-between d-block align-items-center">
                            <div class="me-sm-3 me-0">
                                <h6 class="fs-16 font-w600 mb-sm-2 mb-0">
                                    <a href="" class="text-black">Universitas Indonesia</a>
                                </h6>
                                <p class="text-black mb-1">Baru saja diperbarui.</p>
                    ...
                    <div class="media mb-3 pb-3 border-bottom">
                        <div class="image-bx me-sm-4 me-2">
                            <img src="{{ asset('assets') }}/public/assets/images/profile/Untitled-2.jpg" alt=""
                                class="rounded-circle img-1">
                        </div>
                        <div class="media-body d-sm-flex justify-content-between d-block align-items-center">
                            <div class="me-sm-3 me-0">
                                <h6 class="fs-16 font-w600 mb-sm-2 mb-0">
                                    <a href="" class="text-black">ITB</a>
                                </h6>
                                <p class="text-black mb-1">Baru saja diperbarui.</p>
